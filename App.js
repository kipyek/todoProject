...
export default function App() {
  ...
  const CompleteTasks = (index) => {
    let itemComplete = [...taskItem]
    itemComplete.splice(index, 1);
    setTaskItem(itemComplete)
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <TextInput style={styles.input} placeholder={'Type a task...'} value={task} onChangeText={text => setTask(text)} />
